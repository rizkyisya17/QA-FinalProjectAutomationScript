...
WebUI.click(findTestObject('Web - Change Profile/Page_Coding.ID - Dashboard/a_Edit Profile'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Web - Change Profile/Page_Coding.ID - Dashboard/button_Save Changes'))
