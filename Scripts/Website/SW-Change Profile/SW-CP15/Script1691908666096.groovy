...
WebUI.uploadFile(findTestObject('Web - Change Profile/Page_Coding.ID - Dashboard/input_gambar'), 'C:\\Users\\Dermawan\\Desktop\\Katalon Directory\\dummy\\png-transparent-head-the-dummy-avatar-man-tie-jacket-user.png')

WebUI.uploadFile(findTestObject('Web - Change Profile/Page_Coding.ID - Dashboard/input_gambar'), 'C:\\Users\\Dermawan\\Desktop\\Katalon Directory\\dummy\\file_example_PNG_500kB.png')

WebUI.click(findTestObject('Web - Change Profile/Page_Coding.ID - Dashboard/button_Save Changes'))
