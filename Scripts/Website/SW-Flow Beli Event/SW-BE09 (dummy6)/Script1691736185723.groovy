...
WebUI.click(findTestObject('Web - Flow Beli Event/SW-BE01/Page_Online event bersertifikat dari prakti_f42b96/div_Day 3 Predict using Machine Learning   _e04a14'))
...
WebUI.click(findTestObject('Web - Flow Beli Event/SW-BE10/Page_Be a Profressional Talent with Coding.ID/a'))

WebUI.click(findTestObject('Object Repository/Web - Flow Beli Event/SW-BE09/Page_Be a Profressional Talent with Coding.ID/a_My Account'))

WebUI.click(findTestObject('Object Repository/Web - Flow Beli Event/SW-BE09/Page_Coding.ID - Dashboard/span_Invoice'))

WebUI.verifyElementText(findTestObject('Object Repository/Web - Flow Beli Event/SW-BE09/Page_Coding.ID - Dashboard/span_Completed'), 
    'Completed')
