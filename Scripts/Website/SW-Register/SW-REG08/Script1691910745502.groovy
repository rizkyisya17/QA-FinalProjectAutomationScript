...
WebUI.setText(findTestObject('Web - Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_Nama_name'), 'iqbal21519')
...
WebUI.setText(findTestObject('Web - Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_E-Mail_email'), 'epf7h6t21r@icznn.com')
